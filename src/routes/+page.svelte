<script>
  ...
  function getGridArea(index) {
    const gridAreas = [
      "col-start-2 col-span-1 row-start-1 row-span-1", // top center
      "col-start-2 col-span-1 row-start-3 row-span-1", // bottom center
      "col-start-1 col-span-1 row-start-2 row-span-1", // middle left
      "col-start-3 col-span-1 row-start-2 row-span-1", // middle right
      "col-start-2 col-span-1 row-start-2 row-span-1", // middle center
    ]
